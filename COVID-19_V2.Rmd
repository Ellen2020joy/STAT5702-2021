...
# %y assumes 2 digit year, %Y assumes 4 digit year
```
...
ggplot( ) +
  ...
  scale_x_date(date_labels = "%d/%m", date_breaks = "2 weeks") +  # set x axis label
  ggtitle(paste0("Daily Cases in ",location))  # on the topleft
